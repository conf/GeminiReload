...
<div class="b-wrapper">
    <div class="b-auth">
        <div class="b-auth__logout">
            <span class="b-auth__user">Hello, Alex Shein</span>
    ...
    <!-- b-timeline -->
    <div class="b-tasks">
        <div class="b-fieldset" data-core-module="ticket.module.GetProjects">
            <label for="project">Choose Project</label>
            <select name="project" id="project">
                <option value="1">APG Security (APG SECURI) 1</option>
                <option value="2">APG Security (APG SECURI) 2</option>
                <option value="3">APG Security (APG SECURI) 3</option>
                <option value="4">APG Security (APG SECURI) 4</option>
                <option value="1">APG Security (APG SECURI) 1</option>
                <option value="2">APG Security (APG SECURI) 2</option>
                <option value="3">APG Security (APG SECURI) 3</option>
                <option value="4">APG Security (APG SECURI) 4</option>
        ...
        <div class="b-fieldset" data-core-module="ticket.module.GetTasks">
